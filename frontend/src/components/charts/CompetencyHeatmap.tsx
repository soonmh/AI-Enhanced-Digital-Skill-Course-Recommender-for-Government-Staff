  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-5">
        <div className="flex items-center gap-2.5 px-3.5 py-2.5 rounded-lg bg-green-500/10 border border-green-100">
        ...
        <div className="flex items-center gap-2.5 px-3.5 py-2.5 rounded-lg bg-blue-500/10 border border-blue-100">
        ...
        <div className="flex items-center gap-2.5 px-3.5 py-2.5 rounded-lg bg-amber-500/10 border border-amber-100">
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-background">
              <th className="py-3 px-2 text-center text-[11px] font-bold text-muted-foreground uppercase tracking-wider w-10">
                #
              </th>
              <th className="py-3 px-3 text-left text-[11px] font-bold text-muted-foreground uppercase tracking-wider min-w-[180px]">
                Field
              </th>
              {codes.map((code) => (
                <th
                ...
                >
                  <div className="text-[11px] font-bold text-muted-foreground">{code}</div>
                  <div className="text-[9px] text-muted-foreground font-medium leading-tight mt-0.5">
                    {shortName(code)}
                  </div>
                </th>
              ))}
              ...
              <th className="py-3 px-2 text-center text-[11px] font-bold text-muted-foreground uppercase tracking-wider min-w-[48px]">
                Staff
              </th>
            </tr>
          </thead>
          <tbody>
            {sorted.map((dept, idx) => {
              ...
              return (
                <tr key={dept.name} className="group transition-colors border-t border-border first:border-t-0">
                  <td className="py-3 px-2 text-center text-xs font-bold text-muted-foreground">
                    {idx + 1}
                  </td>
                  <td className="py-3 px-3 align-top">
                    <p className="text-[13px] font-semibold text-foreground whitespace-nowrap">{dept.name}</p>
          ...
          <tfoot>
            <tr className="border-t-2 border-border bg-background">
              <td className="py-3 px-2 text-center text-xs text-muted-foreground font-bold">—</td>
              <td className="py-3 px-3">
                <p className="text-[13px] font-bold text-muted-foreground">Average</p>
              </td>
              {avgRow.map((val, i) => {
      ...
      {/* Legend */}
      <div className="mt-4 p-3.5 rounded-lg bg-background border border-border">
        <div className="flex items-center gap-3 text-xs">
          <span className="font-semibold text-muted-foreground shrink-0">Scale</span>
        ...
        <div className="flex items-center justify-between mt-1.5 px-6 text-[10px] text-muted-foreground">
          <span>&lt;20%</span>
          <span>20%</span>
          <span>40%</span>
          <span>50%</span>
