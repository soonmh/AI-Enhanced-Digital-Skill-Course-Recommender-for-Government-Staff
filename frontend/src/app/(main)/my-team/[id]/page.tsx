...
import { useTeamMemberReport } from "@/hooks/useApi";
...
export default function TeamMemberReportPage() {
  ...
  const { data, isLoading } = useTeamMemberReport(params.id as string);
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-lg font-semibold text-foreground mb-2">Team member not found</h3>
          <Link href="/my-team" className="text-violet-600 font-medium">Back to My Team</Link>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-card shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link href="/my-team" className="p-2 hover:bg-muted rounded-lg transition-colors">
